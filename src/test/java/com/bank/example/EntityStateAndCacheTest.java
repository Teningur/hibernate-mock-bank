...
class EntityStateAndCacheTest extends BaseTest {
    ...
    void exercise3_1() {
        Tariff tariff = persistTariffAndReturn();
        em.clear();
        Long id1 = tariff.getId();
        Long id2 = tariff.getId();
        Long id3 = tariff.getId();

        tariff = em.find(Tariff.class, id1);

        tariff = em.find(Tariff.class, id2);

        tariff = em.find(Tariff.class, id3);
    }
